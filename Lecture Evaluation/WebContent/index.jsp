...
<body>
	<%
		...
		boolean emailChecked = new UsersDAO().getUserEmailChecked(userID);
	...
	<div class="container">
		...
		<div class="card bg-light mt-3">
			...
			<div class="card-body">
				...
				<p class="card-text"><%=evaluation.getEvalutionContent()%></p>
				<div class="row">
 ...
 <a class="page-link"href="./index.jsp?lectureDivide=<%=URLEncoder.encode(lectureDivide, "UTF-8")%>&searchType=<%=URLEncoder.encode(searchType, "UTF-8")%>&search=<%=URLEncoder.encode(search, "UTF-8")%>&pageNumber=<%=pageNumber + 1%>">다음</a>
					...
					<form action="./evaluationRegisterAction.jsp" method="post">
						...
						<div class="form-row">
							<div class="form-group col-sm-4">
								<label>수강 년도</label> <select name="lectureYear" 	class="form-control">
							...
							<div class="form-group col-sm-4">
								<label>수강 학기</label> <select name="semesterDivide"	class="form-control">
	...
	<footer class="bg-dark mt-4 p-5 text-center" style="color: #FFFFFF;">
		Copyright ⓒ 2019 민슈가 짱짱맨 뿡뿡 All Rights Reserved. </footer>
	<!-- 제이쿼리 자바스크립트 추가하기 -->
